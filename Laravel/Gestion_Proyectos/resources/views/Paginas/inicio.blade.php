                        ...
                        @foreach($proyecto as $key => $value)
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <a class="btn btn-info btn-sm"  href="{{url('/proyectos/'.Illuminate\Support\Facades\Crypt::encrypt($value->Clave).'/edit')}}">
                                    ...
                                    <a>
                                        <form  method="post" action="{{route('proyectos.destroy',$value->Clave)}}"
                                            ...
                                            <button id="btneliminar" type="submit" value="eliminar" class="btn btn-danger btn-sm">
                                                Eliminar
                                            </button>
                                        </form>
                                    </a>
